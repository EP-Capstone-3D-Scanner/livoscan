...
def generate_launch_description():
    ...
    # Find path
    config_file_dir = os.path.join(get_package_share_directory("livoscan"), "fast_livo")
    rviz_config_file = os.path.join(get_package_share_directory("livoscan"), "fast_livo", "fast_livo2.rviz")
